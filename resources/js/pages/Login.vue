      ...
      <div class="login__inner">
        <form @submit.prevent="login" class="form-login text-center needs-validation"
          ...
          <div class="form-group">
            <input type="email" v-model="emailLogin" class="form-control" placeholder="メールアドレス" autocomplete="off"
              required />
            <span class="icon focus__form-control"><font-awesome-icon :icon="['fas', 'envelope']" /></span>
          </div>
          <div class="form-group mt-5">
            <input type="password" v-model="passwordLogin" class="form-control" placeholder="パスワード" autocomplete="off"
              required />
